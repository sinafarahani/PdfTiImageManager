<nav x-data="{ open: false }" class="bg-white border-b border-gray-100">
        ...
        <div class="flex justify-between h-16">
            <div class="flex">
                ...
                <div class="hidden space-x-8 sm:-my-px sm:ms-10 sm:flex">
                    ...
                    <x-nav-link href="{{ route('failures') }}" :active="request()->routeIs('failures')">
                        {{ __('Failures') }}
                    </x-nav-link>
                </div>
            </div>

            {{-- Anyone who can reach the panel may watch it, so the bar is rendered for a visitor too:
                 signed in it carries the account menu, signed out only a way in. --}}
            @guest
    ...
    <div :class="{'block': open, 'hidden': ! open}" class="hidden sm:hidden">
        <div class="pt-2 pb-3 space-y-1">
            ...
            <x-responsive-nav-link href="{{ route('failures') }}" :active="request()->routeIs('failures')">
                {{ __('Failures') }}
            </x-responsive-nav-link>
